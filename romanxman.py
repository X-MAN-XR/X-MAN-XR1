...
def update():
    ...
    try:
        ...
        mainVersion = requests.get("https://github.com/X-MAN-XR").text
    ...
    os.system("cd .. && rm -rf X-MAN-XR && git clone https://github.com/X-MAN-XR > /dev/null 2>&1")
    ...
    os.system("cd .. && cd X-MAN-XR && python X-MAN-XR.py")
...
def logo():
 ...
 /_/ \_\    |_|  |_/_/    \_\_| \_|│".center(columns+15))
    ...
    print("\033[94m│ \033[95mAuthor : X-MAN

                     \033[94m│".center(columns+15))

    print("│ \033[95mTool   : BD SMS Bomber          \033[94m│".center(columns+9))

    print("│ \033[95mGitHub : https://github.com/X-MAN-XR \033[94m│".center(columns+9))
